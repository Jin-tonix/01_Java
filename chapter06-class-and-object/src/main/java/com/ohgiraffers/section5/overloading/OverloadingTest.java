package main.java.com.ohgiraffers.section5.overloading;
...
public class OverloadingTest {
    ...
    * */
    ...
    /*
    * 오버로딩의 사용 이유
    * 매겨변수으 ㅣ종류별로 메소드 내용을 다르게 작성해야 하는 경우들이 종종있다.
    * 이 때, 동일한 기능의 메소드를 매개변수에 따라 다르게 이름을 정의하면 복잡하고 관리가 매우 어려울 것이다.
    ...
    * 사용하는 기술을 오버로딩이라고 한다.
    ...
    //public String test(){
    //   return "" //반환값을 존재하지만 애초에 매서드가 식별되지 않음.

    //private void test(){} 메서드 내부에서 식별이 불가능하다.
