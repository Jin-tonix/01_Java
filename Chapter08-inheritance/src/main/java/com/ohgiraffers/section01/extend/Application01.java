...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        /*
        *상속
        * 상속(inheritance)은 현실 시계의 상속과 비슷한 개념이다.
        ...
        *       상속 구조가 복잡해 질 수록 그 영향에 대한 예측이 힘들며 이러한 단점이
        *       유지보수성 증가한다는 장점과는 반대로 유지보수에 악영향을 미친다.
        * 2. 또한 부모클래스의 변경 또한 쉽지 않다. 자식클래스에서 중요하게 사용하는 기능인 경우
        *       역시 유지보수에 악영향을 미친다.
        * 3. 부모클래스에서는 의미있었던 기능이 자식클래스에서는 무의미할 수 있다.
        *
        * 장점과 단점을 고려했을 때,
        * 상속은 재사용이라는 장점만 바라보게 되면 오용의 가능성이 있기 떄문에 유지보수에 좋지 않는 코드를
        *   작성할 확률이 높다.
        * 상속은 IS_A관계로 구분되는 경우에만 사용해야 한다.
        *
        ...
        * 객체지향 프로그램이다.
        *
        * 적절한 책임을 수행하는 객체 또한 그 객체만 수행할 수 있는 기능이라기 보다 역활의 관점으로 바라봐야 한다.
        ...
        *   객체별로 그 메세지에 등답하는 방식은 서로 다를 수 있다.(다향성)
